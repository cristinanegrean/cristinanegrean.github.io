...
* [Spark standalone](https://spark.apache.org/docs/latest/spark-standalone.html) with PySpark and Jupyter notebook local installation which I describe in below section `Setup your own Apache Spark, PySpark and Jupyter Notebooks Playground` section
